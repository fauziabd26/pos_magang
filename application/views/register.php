							...
							<div class="card-body">
								...
								<form action="<?= base_url('auth/proses_register') ?>" method="POST">
									...
									<div class="form-group">
										...
										<input id="nama_toko" type="text" class="form-control" name="nama_toko" placeholder="Masukan Nama Toko">
									</div>

									<div class="form-group">
										<label for="alamat">Alamat Toko</label>
										<textarea class="form-control" name="alamat_toko" id="alamat_toko" placeholder="Masukan Alamat Toko"></textarea>
									</div>
									<div class="form-group">
										<label for="deskripsi_toko">Deskripsi Toko</label>
										<textarea class="form-control" name="deskripsi_toko" id="deskripsi_toko" placeholder="Masukan Deskripsi Toko"></textarea>
									</div>
									<div class="form-group">
