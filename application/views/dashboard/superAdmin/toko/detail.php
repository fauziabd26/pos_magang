				...
				<div class="card-body">
					...
					<div class="col-12">
						...
						<div class="form-group">
							...
							<input type="text" id="nama" class="form-control bg-white" name="nama" value="<?= $toko["nama_toko"] ?? "-" ?>" disabled>
						</div>
						<div class="form-group">
							<label>Alamat Lengkap Toko</label>
							<textarea class="form-control bg-white" disabled><?= $toko["alamat"] ?? "-" ?></textarea>
						</div>
						<div class="form-group">
							<label>Deskripsi Toko</label>
							<textarea class="form-control bg-white" disabled><?= $toko["deskripsi_toko"] ?? "-" ?></textarea>
						</div>
						<div class="form-group">
							<label for='foto_toko'>Dokumen Toko</label>
							<input type="input" class="form-control bg-white" placeholder="Ini Foto / Dokumen Toko">
					...
					<div class="col-12">
						...
						<div class="form-group">
							...
							<input id="nama" class="form-control bg-white" value="<?= $toko["nama_owner"] ?? "-" ?>" disabled>
						</div>
						<div class="form-group">
							<label for="email">Email</label>
							<input id="email" type="email" class="form-control bg-white" value="<?= $toko["email"] ?? "-" ?>" disabled>
						</div>
						<div class="form-group">
							<label for="no_hp">Nomer Handhphone</label>
							<input id="no_hp" class="form-control bg-white" value="<?= $toko["no_hp"] ?? "-" ?>" disabled>
						</div>
					</div>
				</div>
			</form>
