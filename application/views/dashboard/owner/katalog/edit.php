<section class="section">
	...
	<div class="section-body">
		<div class="card">
			<form action="<?= base_url('owner/proses_edit_katalog/' . $KatalogProduk['id_detail_produk']) ?>" method="POST">
				<div class="card-body">
					<div class="row mb-3">
						<div class="col">
					...
					<div class="row">
						<div class="col-6">
							<div class="form-group">
								<label for='nama_satuan' class="control-label">Pilih Satuan</label>
						...
						<div class="col-6">
							<div class="form-group">
								<label for='nama_harga' class="control-label">Pilih Harga</label>
					...
					<div class="form-group">
						...
						<input type="text" id="nominal" class="form-control" name="nominal" placeholder="Masukan Nominal" value="<?= $KatalogProduk["nominal"] ?>">
					</div>
