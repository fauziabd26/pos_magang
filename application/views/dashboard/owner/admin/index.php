                    ...
                    <table id="example1" class="table table-bordered table-hover">
                        ...
                        <tbody align="center">
                            ...
                            <tr>
                                ...
                                <td class="text-center"><?= $admin["no_hp"] ?></td>
                                <td class="text-center"><?= $admin["nama_toko"] ?></td>
                                <td class="text-center">
                                    <a href=" <?= base_url('owner/admin_edit/' . $admin["id_user"]) ?>"
                                        class="btn btn-warning"><i class="fas fa-edit"></i></a>
                                    <a href="<?= base_url('owner/admin_hapus/' . $admin["id_user"]) ?>"
