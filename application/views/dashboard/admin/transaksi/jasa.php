							...
							<div class="row">
								...
								<div class="col-lg-6 col-12">
									...
									<?php if (!empty($transaksi['total_transaksi'])) { ?>
														...
														<tr>
															...
															<td>
																<div class="row align-items-center">
																	<form action="<?= base_url('admin/stok_kurang_jasa/' . $row['id_detail_trans_produk']) ?>" method="POST">
																		<?php if ($row['qty'] > 1) { ?>
																	...
																	<span><?= $row['qty'] ?></span>
																	<form action="<?= base_url('admin/stok_tambah_jasa/' . $row['id_detail_trans_produk']) ?>" method="POST">
															...
															<td>
																<a href="<?= base_url('admin/hapus_detail_transaksi_jasa/' . $row['id_detail_trans_produk']) ?>" class="btn btn-danger"><i class="fas fa-trash"></i></a>
															</td>
														</tr>
													<?php endforeach; ?>
												<?php } ?>
										...
										<!-- </div> -->
										<form action="<?= base_url('admin/konfirmasi_jasa/' . $transaksi['id_transaksi']) ?>" method="POST">
			...
			<div class="modal fade" data-keyboard="false" tabindex="-1" role="dialog" id="produk<?= $produk['id_detail_produk'] ?>">
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<form action="<?= base_url('admin/proses_tambah_transaksi_jasa/' . $produk['id_detail_produk']) ?>" method="POST">
